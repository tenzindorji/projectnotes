...
- `docker run -d --restart=unless-stopped -p 80:80 -p 443:443 -v /opt/rancher:/var/lib/rancher rancher/rancher:v2.4.5` # bind to docker vol to persistent location /opt/ and /var/

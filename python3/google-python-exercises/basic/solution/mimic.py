...
def mimic_dict(filename):
  ...
  prev = ''
  for word in words:
    if not prev in mimic_dict: # loop by key
      mimic_dict[prev] = [word] #?? Assign value in a list to dict . dict = {'':['a']}
    else:
      mimic_dict[prev].append(word) #append value for the key prev
